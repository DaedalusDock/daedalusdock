...
/obj/machinery/networked/phone_director
...
/obj/machinery/networked/phone_director/Initialize(mapload)
	. = ..()
	if(mapload)
		roundstart_server = TRUE

/obj/machinery/networked/phone_director/LateInitialize()
	. = ..()
...
/obj/machinery/networked/phone_director/receive_signal(datum/signal/signal)
	. = ..()
	if(.)
		return
