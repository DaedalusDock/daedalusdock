...
#define SHOULD_RESIST(source) (source.on_fire || source.buckled || HAS_TRAIT(source, TRAIT_RESTRAINED) || (source.grabbedby && source.grabbedby.current_state > GRAB_LEVEL_PULL))
