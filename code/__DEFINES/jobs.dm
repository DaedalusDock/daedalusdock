...
//Salvage
#define JOB_SALVAGE_FOREMAN "Salvage Foreman" //Foreman is not a head, just a expedition leader. They aren't a part of Daedalus, hence not in command.
...
#define JOB_DISPLAY_ORDER_SALVAGE_FOREMAN 22
#define JOB_DISPLAY_ORDER_SALVAGE_OPERATOR 23
...
#define DEPARTMENT_BITFLAG_SALVAGE (1<<4)
#define DEPARTMENT_SALVAGE "Salvage"
#define DEPARTMENT_BITFLAG_ENGINEERING (1<<5)
#define DEPARTMENT_ENGINEERING "Engineering"
#define DEPARTMENT_BITFLAG_SCIENCE (1<<6)
#define DEPARTMENT_SCIENCE "Science"
#define DEPARTMENT_BITFLAG_MEDICAL (1<<7)
#define DEPARTMENT_MEDICAL "Medical"
#define DEPARTMENT_BITFLAG_SILICON (1<<8)
#define DEPARTMENT_SILICON "Silicon"
#define DEPARTMENT_BITFLAG_ASSISTANT (1<<9)
#define DEPARTMENT_ASSISTANT "Assistant"
#define DEPARTMENT_BITFLAG_CAPTAIN (1<<10)
