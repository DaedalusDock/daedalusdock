...
#define DIGITIGRADE_UNIFORM_FILE 'icons/mob/clothing/under/uniform_digi.dmi' //PARIAH EDIT
...
#define DIGITIGRADE_SUIT_FILE 'icons/mob/clothing/suits/suit_digi.dmi' //PARIAH EDIT

//PARIAH EDIT ADDITION
///The dmi containing snouted variation masks
#define SNOUTED_MASK_FILE 'icons/mob/clothing/mask_muzzled.dmi'

#define SNOUTED_HEAD_FILE 'icons/mob/clothing/head/head_muzzled.dmi'
