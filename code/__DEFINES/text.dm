...
/// Creates a maptext icon given an icon reference, with custom scaling parameters.
#define MAPTEXT_ICON_OF_SIZE(ICON, w, h) "<IMG CLASS=icon SRC=\ref[ICON] style='width:[w];height:[h]'>"
