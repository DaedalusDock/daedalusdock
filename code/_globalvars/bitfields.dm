...
DEFINE_BITFIELD(disease_flags, list(
	"DISEASE_RESIST_ON_CURE" = DISEASE_RESIST_ON_CURE,
	"DISEASE_CURABLE" = DISEASE_CURABLE,
	"DISEASE_NEED_ALL_CURES" = DISEASE_NEED_ALL_CURES,
	"DISEASE_REGRESS_TO_CURE" = DISEASE_REGRESS_TO_CURE
))
