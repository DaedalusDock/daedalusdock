...
// First and last names by country.
GLOBAL_LIST_INIT(austria_forenames, world.file2list("strings/names/country/austria_forenames.txt"))
GLOBAL_LIST_INIT(austria_surnames, world.file2list("strings/names/country/austria_surnames.txt"))
GLOBAL_LIST_INIT(chile_forenames, world.file2list("strings/names/country/chile_forenames.txt"))
GLOBAL_LIST_INIT(chile_surnames, world.file2list("strings/names/country/chile_surnames.txt"))
GLOBAL_LIST_INIT(greece_forenames, world.file2list("strings/names/country/greece_forenames.txt"))
GLOBAL_LIST_INIT(greece_surnames, world.file2list("strings/names/country/greece_surnames.txt"))
GLOBAL_LIST_INIT(netherlands_forenames, world.file2list("strings/names/country/netherlands_forenames.txt"))
GLOBAL_LIST_INIT(netherlands_surnames, world.file2list("strings/names/country/netherlands_surnames.txt"))
GLOBAL_LIST_INIT(ukraine_forenames, world.file2list("strings/names/country/ukraine_forenames.txt"))
GLOBAL_LIST_INIT(ukraine_surnames, world.file2list("strings/names/country/ukraine_surnames.txt"))
GLOBAL_LIST_INIT(wales_forenames, world.file2list("strings/names/country/wales_forenames.txt"))
GLOBAL_LIST_INIT(wales_surnames, world.file2list("strings/names/country/wales_surnames.txt"))
