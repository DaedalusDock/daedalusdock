...
/datum/component/storage/proc/mob_item_insertion_feedback(mob/user, mob/M, obj/item/I, override = FALSE)
	...
	for(var/mob/viewing in viewers(user, null))
		...
		else if(IN_GIVEN_RANGE(M, viewing, DEFAULT_MESSAGE_RANGE / 4 * I.w_class)) //If someone is standing close enough, they can tell what it is...
			viewing.show_message(span_subtle("[M] puts [I] [insert_preposition]to [parent]."), MSG_VISUAL)
