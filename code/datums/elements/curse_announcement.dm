...
/datum/element/curse_announcement/Attach(datum/target, announcement_message, filter_color, new_name, datum/component/fantasy/fantasy_component)
	...
	if(cursed_item.slot_equipment_priority) //if it can equip somewhere, only go active when it is actually done
		RegisterSignal(cursed_item, COMSIG_ITEM_EQUIPPED, PROC_REF(on_equipped), TRUE) //https://discord.com/channels/326822144233439242/326831214667235328/1147281648791081051
	else
		RegisterSignal(cursed_item, COMSIG_ITEM_PICKUP, PROC_REF(on_pickup), TRUE) //https://discord.com/channels/326822144233439242/326831214667235328/1147281648791081051
