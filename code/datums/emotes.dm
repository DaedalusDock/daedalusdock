...
/datum/emote/proc/run_emote(mob/user, params, type_override, intentional = FALSE)
	...
	// PARIAH EDIT - Better emotes // Original: var/dchatmsg = "<b>[user]</b> [msg]"
	...
	if(emote_type == EMOTE_AUDIBLE)
		user.audible_message(msg, deaf_message = "<span class='emote'>You see how <b>[user]</b>[space][msg]</span>", audible_message_flags = EMOTE_MESSAGE, separation = space) // PARIAH EDIT // Original: user.audible_message(msg, deaf_message = "<span class='emote'>You see how <b>[user]</b> [msg]</span>", audible_message_flags = EMOTE_MESSAGE)
	else
		user.visible_message(msg, blind_message = "<span class='emote'>You hear how <b>[user]</b>[space][msg]</span>", visible_message_flags = EMOTE_MESSAGE, separation = space) // PARIAH EDIT // Original: user.visible_message(msg, blind_message = "<span class='emote'>You hear how <b>[user]</b> [msg]</span>", visible_message_flags = EMOTE_MESSAGE)
