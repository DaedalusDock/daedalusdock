...
/datum/symptom/voice_change/sync_properties(list/properties)
	...
	if(properties[PATHOGEN_PROP_STAGE_RATE] >= 7) //faster change of voice
		base_message_chance = 25
		symptom_delay_min = 25
		symptom_delay_max = 85
	if(properties[PATHOGEN_PROP_TRANSMITTABLE] >= 14) //random language
...
/datum/symptom/voice_change/on_stop_processing(datum/pathogen/advance/A)
	. = ..()
