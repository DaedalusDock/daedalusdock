...
/datum/quirk/item_quirk/blindness/remove()
	 ...
	 * - 5u Alkysine will heal 12.5% (25 organ damage) brain damage
	 */
...
/datum/quirk/social_anxiety/proc/handle_speech(datum/source, list/speech_args)
	...
	var/moodmod = (1+0.02*(50-(max(50, 0.1*quirk_holder.nutrition))))
	var/nearby_people = 0
	...
	if(message)
		...
		for(var/word in message_split)
			...
			if(prob(max(5,(nearby_people*12.5*moodmod)))) //Minimum 1/20 chance of stutter
				...
				new_message += quirker.treat_message(word, correct_grammar = FALSE)
...
/datum/quirk/item_quirk/allergic
	...
	var/list/blacklist = list(/datum/reagent/medicine/epinephrine,/datum/reagent/medicine/adminordrazine,/datum/reagent/medicine/tricordrazine/godblood,/datum/reagent/cordiolis_hepatico,/datum/reagent/medicine/diphenhydramine)
	var/allergy_string
