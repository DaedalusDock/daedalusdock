...
/datum/map_template/ruin/lavaland/ash_walker
	...
	id = "ash-walker"
	description = "A race of unbreathing unathi live here, that run faster than a human can, worship a broken dead city, and are capable of reproducing by something involving tentacles? \
