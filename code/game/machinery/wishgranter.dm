...
/obj/machinery/wish_granter/attack_hand(mob/living/carbon/user, list/modifiers)
	...
	if(charges <= 0)
		...
		to_chat(user, span_boldnotice("You speak. [pick("I want the station to disappear","Minervanity is corrupt, mankind must be destroyed","I want to be rich", "I want to rule the world","I want immortality.")]. The Wish Granter answers."))
