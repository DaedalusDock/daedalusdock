...
/obj/item/match/fire_act(exposed_temperature, exposed_volume, exposed_pressure, turf/adjacent)
	matchignite()
...
/obj/item/clothing/mask/cigarette/fire_act(exposed_temperature, exposed_volume, exposed_pressure, turf/adjacent)
	light()
