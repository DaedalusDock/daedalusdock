/obj/item/encryptionkey
	...
	/// Signifies that it can de-crypt the binary channel.
	var/translate_binary = FALSE
	/// Signifies that it can de-crypt Syndicate transmissions.
	var/syndie = FALSE
	/// Signifies that it can de-crypt the independent channels.
	var/independent = FALSE
	/// List of all channels that this key can de-crypt.
...
//? Ported from NT, this goes 'inside' the AI.
