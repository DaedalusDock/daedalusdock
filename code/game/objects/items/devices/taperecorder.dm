...
/obj/item/taperecorder/fire_act(exposed_temperature, exposed_volume, exposed_pressure, turf/adjacent)
...
/obj/item/tape/fire_act(exposed_temperature, exposed_volume, exposed_pressure, turf/adjacent)
	unspool()
	..()
