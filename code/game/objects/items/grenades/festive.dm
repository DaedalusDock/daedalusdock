...
/obj/item/sparkler/fire_act(exposed_temperature, exposed_volume, exposed_pressure, turf/adjacent)
	light()
...
/obj/item/grenade/firecracker/fire_act(exposed_temperature, exposed_volume, exposed_pressure, turf/adjacent)
	detonate()
