...
/obj/structure/window/reinforced
	...
	armor = list(BLUNT = 30, PUNCTURE = 0, SLASH = 0, LASER = 0, ENERGY = 0, BOMB = 25, BIO = 100, FIRE = 80, ACID = 100)
	max_integrity = 75
	explosion_block = 1
...
/obj/structure/window/plasma
	...
	armor = list(BLUNT = 60, PUNCTURE = 5, SLASH = 0, LASER = 0, ENERGY = 0, BOMB = 45, BIO = 100, FIRE = 99, ACID = 100)
	max_integrity = 200
	explosion_block = 1
...
/obj/structure/window/reinforced/plasma
	...
	armor = list(BLUNT = 80, PUNCTURE = 20, SLASH = 0, LASER = 0, ENERGY = 0, BOMB = 60, BIO = 100, FIRE = 99, ACID = 100)
	max_integrity = 500
...
/obj/structure/window/reinforced/shuttle //this is called reinforced because it is reinforced w/titanium
	...
	reinf = TRUE
	heat_resistance = 1600
	armor = list(BLUNT = 75, PUNCTURE = 0, SLASH = 0, LASER = 0, ENERGY = 0, BOMB = 50, BIO = 100, FIRE = 80, ACID = 100)
	smoothing_flags = SMOOTH_BITMASK
...
/obj/structure/window/reinforced/plasma/plastitanium
	...
	flags_1 = PREVENT_CLICK_UNDER_1
	heat_resistance = 1600
	armor = list(BLUNT = 95, PUNCTURE = 0, SLASH = 0, LASER = 0, ENERGY = 0, BOMB = 50, BIO = 100, FIRE = 80, ACID = 100)
	smoothing_flags = SMOOTH_BITMASK
	smoothing_groups = SMOOTH_GROUP_WINDOW_FULLTILE
	canSmoothWith = SMOOTH_GROUP_SHUTTERS_BLASTDOORS + SMOOTH_GROUP_AIRLOCK + SMOOTH_GROUP_WINDOW_FULLTILE + SMOOTH_GROUP_WALLS
	explosion_block = 3
