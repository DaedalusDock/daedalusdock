...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if(SFX_KEYBOARD)
				soundin = pick(
					'sound/effects/keyboard/keypress1.ogg',
					'sound/effects/keyboard/keypress2.ogg',
					'sound/effects/keyboard/keypress3.ogg',
					'sound/effects/keyboard/keypress4.ogg',
					'sound/effects/keyboard/keystroke4.ogg',
				)
			if(SFX_GLASS_CRACK)
				soundin = pick(
