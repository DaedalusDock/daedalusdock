...
/datum/admins/proc/show_lag_switch_panel()
	...
	dat += "Disable VV Icon Preview Generation: <a href='byond://?_src_=holder;[HrefToken()];change_lag_switch=[DISABLE_VV_ICON_PREVIEW]'><b>[SSlag_switch.measures[DISABLE_VV_ICON_PREVIEW] ? "On" : "Off"]</b></a><br/>"
