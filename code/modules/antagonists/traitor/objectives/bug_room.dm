...
/datum/traitor_objective/bug_room
	...
	var/list/applicable_heads = list(
		...
		JOB_MAYOR = /area/station/command/heads_quarters/captain, // For head roles so that they can still get this objective.
	)
...
/datum/traitor_objective/bug_room/risky
	...
	applicable_heads = list(
		JOB_MAYOR = /area/station/command/heads_quarters/captain,
	)
...
/datum/traitor_objective/bug_room/super_risky
	...
	applicable_heads = list(
		JOB_POLICE_CHIEF = /area/station/command/heads_quarters/hos,
	)
