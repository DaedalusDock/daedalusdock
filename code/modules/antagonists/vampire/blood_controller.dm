...
/datum/blood_controller/proc/get_blood_packet(mob/living/victim)
...
/datum/blood_controller/proc/get_blood_remaining(mob/living/victim)
	var/datum/vampire_blood_packet/packet = get_blood_packet(victim)
	return packet.remaining_blood

/datum/blood_controller/proc/drain_blood(mob/living/victim, amount)
	var/datum/vampire_blood_packet/packet = get_blood_packet(victim)
