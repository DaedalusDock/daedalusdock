/obj/item/clothing/head/helmet/space/hardsuit/engine
	...
	armor = list(MELEE = 15, BULLET = 5, LASER = 10, ENERGY = 20, BOMB = 10, BIO = 100, FIRE = 100, ACID = 75)
...
/obj/item/clothing/head/helmet/space/hardsuit/atmos
	...
	hardsuit_type = "atmos"
	armor = list(MELEE = 30, BULLET = 5, LASER = 10, ENERGY = 20, BOMB = 10, BIO = 100, FIRE = 100, ACID = 75)
