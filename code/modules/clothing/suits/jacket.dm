...
TYPEINFO_DEF(/obj/item/clothing/suit/jacket/puffer)
...
TYPEINFO_DEF(/obj/item/clothing/suit/jacket/puffer/vest)
	default_armor = list(BLUNT = 0, PUNCTURE = 0, SLASH = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 30, FIRE = 0, ACID = 0)
