...
/datum/ai_behavior/flock_find_heal_target/score(datum/ai_controller/controller)
...
/datum/ai_behavior/flock_find_heal_target/proc/get_targets(datum/ai_controller/controller)
	. = list()
...
/datum/ai_behavior/flock_find_heal_target/perform(delta_time, datum/ai_controller/controller, ...)
...
/datum/ai_behavior/flock_find_heal_target/next_behavior(datum/ai_controller/controller, success)
	if(success)
		controller.queue_behavior(/datum/ai_behavior/flock_heal)

/datum/ai_behavior/flock_heal
	behavior_flags = AI_BEHAVIOR_REQUIRE_MOVEMENT

/datum/ai_behavior/flock_heal/perform(delta_time, datum/ai_controller/controller, ...)
	var/mob/living/simple_animal/flock/drone/bird = controller.pawn
...
/datum/ai_behavior/flock_heal/finish_action(datum/ai_controller/controller, succeeded, ...)
	. = ..()
