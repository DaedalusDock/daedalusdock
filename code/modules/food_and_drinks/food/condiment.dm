...
/obj/item/reagent_containers/food/condiment/enzyme/examine(mob/user)
	. = ..()
	#warn FIXME
	var/datum/chemical_reaction/recipe = null //GLOB.chemical_reactions_list[/datum/chemical_reaction/food/cheesewheel]
...
/obj/item/reagent_containers/food/condiment/sugar/examine(mob/user)
	. = ..()
	#warn FIXME
	var/datum/chemical_reaction/recipe = null //GLOB.chemical_reactions_list[/datum/chemical_reaction/food/cakebatter]
...
/obj/item/reagent_containers/food/condiment/flour/examine(mob/user)
	. = ..()
	#warn FIXME
	var/datum/chemical_reaction/recipe_dough = null //GLOB.chemical_reactions_list[/datum/chemical_reaction/food/dough]
	var/datum/chemical_reaction/recipe_cakebatter = null//GLOB.chemical_reactions_list[/datum/chemical_reaction/food/cakebatter]
