...
// 		if(!user.canUseTopic(parent, USE_CLOSE))
...
// 		parent.try_harvest(user, seed_count)
// 		return result
...
// 	if(realName)
// 		podman.set_real_name(realName)
// 	else
// 		podman.set_real_name("Pod Person ([rand(1,999)])")
...
// 	podman.dna.set_all_mutant_colors("#59CE00")
