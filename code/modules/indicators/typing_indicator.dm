GLOBAL_VAR_INIT(typing_indicator_overlay, mutable_appearance('icons/effects/typing_indicator.dmi', "default0", FLY_LAYER))
GLOBAL_VAR_INIT(emote_indicator_overlay, mutable_appearance( 'icons/effects/emote_indicator.dmi', "default0", FLY_LAYER))
