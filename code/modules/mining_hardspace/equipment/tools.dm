...
/obj/item/toolsalvage/saw
	name = "OVERKILL Salvage Driver"
	desc = "A specialized salvage operations tool designed for destructive removal of hardened materials such as plasteel casings, radiation shielding, or durasteel using a hardened plasma-saw. Or safety deposit boxes if your that kinda guy."
