...
/mob/living/carbon/alien/humanoid/update_icons()
	...
	else if((stat == UNCONSCIOUS && !IsSleeping()) || IsParalyzed())
...
/mob/living/carbon/alien/humanoid/do_update_transform() //The old method of updating lying/standing was update_icons(). Aliens still expect that.
	. = ..()
	update_icons()
