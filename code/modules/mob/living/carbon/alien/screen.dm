...
/mob/living/carbon/alien/proc/updatePlasmaDisplay()
	if(hud_used) //clientless aliens
		hud_used.screen_objects[HUDKEY_ALIEN_PLASMA_DISPLAY].maptext = MAPTEXT("<div align='center' valign='middle' style='position:relative; top:0px; left:6px'><font color='magenta'>[round(getPlasma())]</font></div>")
...
/mob/living/carbon/alien/proc/findQueen()
	if(!hud_used)
		return
	var/atom/movable/screen/alien/alien_queen_finder/finder = hud_used.screen_objects[HUDKEY_ALIEN_QUEEN_FINDER]
	finder.cut_overlays()
