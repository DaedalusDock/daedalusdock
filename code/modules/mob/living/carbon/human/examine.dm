...
//this is very slightly better than it was because you can use it more places. still can't do \his[src] though.
	...
	if(dna.species && !skipface)
		...
		if(SScodex.get_codex_entry(get_codex_value(user)))
			species_text += span_notice(" \[<a href='byond://?src=\ref[SScodex];show_examined_info=\ref[src];show_to=\ref[user]'>?</a>\]")
	...
	if(wear_id && !(wear_id.item_flags & EXAMINE_SKIP))
		var/id_topic = wear_id.GetID() ? " <a href='byond://?src=\ref[wear_id];look_at_id=1'>\[Look at ID\]</a>" : ""
