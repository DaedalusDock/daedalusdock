...
/datum/species/proc/replace_body(mob/living/carbon/target, datum/species/new_species)
	...
	if((new_species.digitigrade_customization == DIGITIGRADE_OPTIONAL && target.dna.features["legs"] == "digitigrade") || new_species.digitigrade_customization == DIGITIGRADE_FORCED)
