...
/mob/living/proc/set_combat_mode(new_mode, silent = TRUE)
	...
	if(combat_mode)
		gurps_stats.set_skill_modifier(4, /datum/rpg_skill/skirmish, SKILL_SOURCE_COMBAT_MODE)
	else
		gurps_stats.remove_skill_modifier(/datum/rpg_skill/skirmish, SKILL_SOURCE_COMBAT_MODE)
