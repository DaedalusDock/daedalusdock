...
/datum/reagent/toxin/leaper_venom/affect_blood(mob/living/carbon/C, removed)
	. = ..()
	if(volume >= 10)
		C.adjustToxLoss(5 * removed, 0, cause_of_death = "Leaper venom")
		return TRUE
...
/mob/living/simple_animal/hostile/jungle/leaper/proc/FinishHop()
	...
	hopping = FALSE
	playsound(src.loc, 'sound/effects/meteorimpact.ogg', 100, TRUE, ignore_walls = 'sound/effects/meteorimpact.ogg')
...
/mob/living/simple_animal/hostile/jungle/leaper/proc/Crush()
	...
	set_density(TRUE)
	notransform = FALSE
	playsound(src, 'sound/effects/meteorimpact.ogg', 200, TRUE, ignore_walls = 'sound/effects/meteorimpact.ogg')
