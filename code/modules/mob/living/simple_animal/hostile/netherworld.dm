...
/datum/action/innate/creature/teleport/Activate()
	...
	if (N.can_be_seen(T) || !do_after(N, T, 60))
...
/mob/living/simple_animal/hostile/netherworld/migo/Initialize(mapload)
	...
	migo_sounds = list(
		...
		'sound/machines/doors/airlock_close.ogg',
		'sound/machines/doors/airlock_open_force.ogg',
		'sound/machines/doors/airlock_close_force.ogg',
