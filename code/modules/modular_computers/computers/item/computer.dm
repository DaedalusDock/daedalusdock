...
/obj/item/modular_computer/GetID(bypass_wallet)
	...
	if(first_id && second_id)
		var/first_id_tally = SSid_access.tally_access(first_id, ACCESS_FLAG_MANAGEMENT)
		var/second_id_tally = SSid_access.tally_access(second_id, ACCESS_FLAG_MANAGEMENT)
