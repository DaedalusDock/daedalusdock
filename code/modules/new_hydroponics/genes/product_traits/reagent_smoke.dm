...
/datum/plant_gene/product_trait/smoke/on_new_plant(obj/item/product, newloc)
	. = ..()
	if(!.)
		return
 ...
 */
/datum/plant_gene/product_trait/smoke/proc/make_smoke(obj/item/our_plant, atom/target)
	SIGNAL_HANDLER
