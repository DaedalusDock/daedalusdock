...
/obj/item/gun/energy/laser/retro
	...
	icon_state = "retro"
	desc = "An older model of the basic lasergun, no longer used by Daedalus' private security. Nevertheless, it is still quite deadly and easy to maintain, making it a favorite amongst pirates and other outlaws."
	ammo_x_offset = 3
