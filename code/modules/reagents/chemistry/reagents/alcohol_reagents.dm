...
/datum/reagent/consumable/ethanol/synthanol
	...
	boozepwr = 50
	quality = DRINK_NICE
	glass_icon = 'icons/obj/drinks.dmi' // This should cover anything synthanol related. Will have to individually tag others unless we make an object path for pariah drinks.
...
/datum/reagent/consumable/ethanol/gunfire
	...
	glass_icon = 'icons/obj/drinks.dmi'
