...
/proc/summon_magic(mob/user, survivor_probability = 0)
	...
	if(GLOB.summon_magic)
		...
		GLOB.summon_magic = new /datum/summon_things_controller(GLOBAL_PROC(give_magic), survivor_probability)
...
/proc/summon_guns(mob/user, survivor_probability = 0)
	...
	if(GLOB.summon_guns)
		...
		GLOB.summon_guns = new /datum/summon_things_controller(GLOBAL_PROC(give_guns), survivor_probability)
