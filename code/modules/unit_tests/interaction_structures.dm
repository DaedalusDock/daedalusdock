...
/datum/unit_test/structure_table_bash/Run()
	...
	var/obj/item/storage/toolbox/toolbox = ALLOCATE_BOTTOM_LEFT()
	var/obj/structure/table/to_smack = ALLOCATE_BOTTOM_LEFT()
...
/datum/unit_test/structure_generic_bash/Run()
	var/mob/living/carbon/human/consistent/attacker = ALLOCATE_BOTTOM_LEFT()
	var/obj/item/storage/toolbox/toolbox = ALLOCATE_BOTTOM_LEFT()
	var/obj/structure/barricade/to_smack = ALLOCATE_BOTTOM_LEFT()
	attacker.put_in_active_hand(toolbox, forced = TRUE)
	click_wrapper(attacker, to_smack)
...
/datum/unit_test/machinery_tool_interaction/Run()
	var/mob/living/carbon/human/consistent/attacker = ALLOCATE_BOTTOM_LEFT()
	var/obj/item/screwdriver/screwdriver = ALLOCATE_BOTTOM_LEFT()
	var/obj/machinery/airalarm/to_smack = ALLOCATE_BOTTOM_LEFT()
