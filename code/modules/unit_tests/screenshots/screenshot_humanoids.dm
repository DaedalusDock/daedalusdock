...
/datum/unit_test/screenshot/screenshot_humanoids/proc/get_flat_icon_for_all_directions(atom/thing)
...
/datum/unit_test/screenshot/screenshot_humanoids/proc/make_dummy(species, job_outfit)
