/obj/item/clothing/mask
	name = "mask"
	icon = 'modular_fallout/master_files/icons/obj/clothing/masks.dmi'
...
/obj/item/clothing/mask/worn_overlays(isinhands = FALSE, icon_file, used_state, style_flags = NONE)
	...
	if(!isinhands)
		if(body_parts_covered & HEAD)
			if(damaged_clothes)
				. += mutable_appearance('modular_fallout/master_files/icons/effects/item_damage.dmi', "damagedmask")
			if(blood_DNA)
				. += mutable_appearance('modular_fallout/master_files/icons/effects/blood.dmi', "maskblood", color = blood_DNA_to_color())
