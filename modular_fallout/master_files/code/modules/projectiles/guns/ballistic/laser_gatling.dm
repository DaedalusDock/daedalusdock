...
/obj/item/minigunpack
	...
	icon = 'modular_fallout/master_files/icons/obj/guns/minigun.dmi'
...
/obj/item/gun/ballistic/minigun/do_fire_gun(atom/target, mob/living/user, message = TRUE, params = null, zone_override = "", bonus_spread = 0, stam_cost = 0)
	if(ammo_pack)
