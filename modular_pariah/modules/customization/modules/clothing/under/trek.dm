//More trek clothing
/obj/item/clothing/under/trek/modular_pariah	//This one needs its own type because TG has their own trek items; makes it MUCH easier to sort and set icon links
...
//VOY
/obj/item/clothing/under/trek/modular_pariah/voy/command
	desc = "The uniform worn by command officers of the 2370s."
	icon_state = "trek_voy_command"
	inhand_icon_state = "r_suit"

/obj/item/clothing/under/trek/modular_pariah/voy/engsec
...
/obj/item/clothing/under/trek/modular_pariah/voy/medsci
	desc = "The uniform worn by medsci officers of the 2370s."
	icon_state = "trek_voy_medsci"
	inhand_icon_state = "b_suit"

//DS9
/obj/item/clothing/under/trek/modular_pariah/ds9/command
	desc = "The uniform worn by command officers of the 2380s."
	icon_state = "trek_ds9_command"
	inhand_icon_state = "r_suit"

/obj/item/clothing/under/trek/modular_pariah/ds9/engsec
	desc = "The uniform worn by operations officers of the 2380s."
	icon_state = "trek_ds9_engsec"
	inhand_icon_state = "y_suit"
	armor = list(MELEE = 10, BULLET = 0, LASER = 0,ENERGY = 0, BOMB = 0, BIO = 0, FIRE = 0, ACID = 0) //copies normal engsec values

/obj/item/clothing/under/trek/modular_pariah/ds9/medsci
